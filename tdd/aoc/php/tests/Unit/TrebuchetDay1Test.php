...
use Kata\trebuchetDay1;
use PHPUnit\Framework\TestCase;

final class TrebuchetDay1Test extends TestCase
{
    public function test_no_digits_in_empty_string(): void
    {
        $validator = new TrebuchetDay1();

        self::assertEmpty($validator->extractTwoDigitNumber(''));
    }

    public function test_no_digits_in_letter_string(): void
    {
        $validator = new TrebuchetDay1();

        self::assertEmpty($validator->extractTwoDigitNumber('abcdef'));
    }

    public function test_two_digits_in_mixed_string_with_two_numbers(): void
    {
        $validator = new TrebuchetDay1();

        self::assertEquals('12', $validator->extractTwoDigitNumber('1abcd2ef'));
    }

    public function test_two_digits_in_mixed_string_with_only_one_numbers(): void
    {
        $validator = new TrebuchetDay1();

        self::assertEquals('11', $validator->extractTwoDigitNumber('asd1sdfsd'));
    }

    public function test_two_digits_in_mixed_string_with_more_than_two_numbers(): void
    {
        $validator = new TrebuchetDay1();

        self::assertEquals('86', $validator->extractTwoDigitNumber('rhrfthv886vflthreeztvzs'));
    }

    public function test_sum_of_digits_in_multiple_strings_with_numbers(): void
    {
        $validator = new TrebuchetDay1();
...
EOT;
        ...
        self::assertEquals('58', $validator->extractSumOfAllTwoDigitNumbers($input));
    }

    public function test_sum_of_digits_in_multiple_strings_with_numbers_and_string_with_one_number(): void
    {
        $validator = new TrebuchetDay1();
...
EOT;
        ...
        self::assertEquals('69', $validator->extractSumOfAllTwoDigitNumbers($input));
    }

    public function test_sum_of_digits_in_multiple_strings_with_numbers_of_final_string(): void
    {
        $validator = new TrebuchetDay1();
...
EOT;
        ...
        self::assertEquals('3788877', $validator->extractSumOfAllTwoDigitNumbers($input));
    }
}
